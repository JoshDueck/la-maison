...
<p> You can create a user account on the site that allows you to access and user certain of its functions and features. You acknowledge and agree that the user identification chosen by you for access and utilization of the site(\"Email\"), and the password selected by and used by you in conjunction with the respective Email are to be kept secure, secret and confidential(\"Password\"). We are authorized to accept such Email and Password as conclusive evidence that you have accessed or utilized the Site.</p>
<br>
...
<p> La Maison collects several different types of personal data for various purposes. Personal may include, but is not limited to:
